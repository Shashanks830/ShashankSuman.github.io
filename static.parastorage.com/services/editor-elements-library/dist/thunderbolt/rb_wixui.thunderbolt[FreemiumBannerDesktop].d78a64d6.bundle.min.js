            ...
            const p = u(32),
                ...
                v = (e, a) => {
                    const {
                        ...
                        "aria-describedby": L,
                        "aria-haspopup": T
                    } = e, I = void 0 !== e.activateByKey ? e.activateByKey : (e => e ? "SpaceOrEnter" : "Space")(u);
                    let z;
                    switch (I) {
                        case "Enter":
                            z = f;
                ...
                FreemiumBannerDesktop: {
                    component: e => {
                        const {
                            ...
                            classNames: u = [g],
                            className: p
                        } = e, f = o(...u.map((e => k[e])), k.desktopTop, "has-custom-focus"), b = r.bannerText.indexOf(E) >= 0;
                        let m = r.bannerText,
                            v = "";
                        if (b) {
...
//# sourceMappingURL=https://static.parastorage.com/services/editor-elements-library/dist/thunderbolt/rb_wixui.thunderbolt[FreemiumBannerDesktop].d78a64d6.bundle.min.js.map