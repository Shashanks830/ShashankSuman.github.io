(() => {
    ...
    function A(e) {
        return Object.keys(e).filter((t => !!e[t] && -1 === y.indexOf(t)))
    }
    ...
    function M() {
        ...
        let t = !1;
        let n;
        if (e instanceof HTMLScriptElement && m.forEach((o => {
    ...
    const R = !!document.documentMode;

    function D(e, t, n) {
        let o;
        R ? (o = document.createEvent("CustomEvent"), o.initCustomEvent(e, !0, !0, n)) : o = new CustomEvent(e, {
            detail: n
    ...
    const k = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz",
        G = k.length;

    function H(e, t) {
        const n = function() {
                let e = "";
                for (let t = 0; t < 16; t++) e += k.charAt(Math.floor(Math.random() * G));
                return e
            }(),
            o = function(e) {
    ...
    function U(e, t, n) {
        ...
        return e.nodeType === Node.TEXT_NODE ? o = document.createTextNode(e.content) : e.nodeType === Node.COMMENT_NODE ? o = document.createComment(e.content) : (o = document.createElement(e.tag), e && e.attributes instanceof NamedNodeMap ? Array.prototype.forEach.call(e.attributes, (e => {
            ...
            void 0 !== typeof e.attributes[t] && B(o, t, e.attributes[t])
            ...
            if (o && "module" === e.getAttribute("type") && "true" === e.getAttribute("accesstoken")) {
                ...
                const {
                    ...
                    const e = U(c.node, c.callbacks, o);
    ...
    function K(e, t, n) {
        const o = e.filter((e => !e.embeddedNodes)),
            r = i(n, u) ? X(o, t) : o,
            c = r.map((e => e.tag));
        v(c), D($.TAGS_LOADING, window, c), r.forEach((e => {
            var t;
            const n = null == (t = e.tag.appInfo) ? void 0 : t.id;
            e.embeddedNodes = e.embeddedNodes || [];
            const o = e.tag,
                r = q(o.content),
                i = o.position && o.position !== Y.HEAD ? document.body : document.head;
            ! function(e, t, n, o, r, i) {
                ...
                onload: j($.TAG_LOADED, o.name, o, N),
                onerror: j($.TAG_LOAD_ERROR, o.name, o, x)
            }, i, o.position === Y.BODY_START, e.embeddedNodes, n)
        }))
    }
    ...
    function ee(e, t) {
        const r = o(e),
            {
                currentPageID: c,
                initConsentPolicyManager: a = !1
            } = t;
        if (r.errors && r.errors.length > 0 && n(JSON.stringify(r.errors)), r.config) {
            const e = window.consentPolicyManager;
            (d = r.config.consentPolicy) && "object" == typeof d && (y = [...y, ...A(d)]), a && e && e.init({
                consentPolicy: r.config.consentPolicy
            }), "object" != typeof(s = r.config) || Array.isArray(s) || (b = { ...b,
                ...s
            })
        }
        var s, d, u, f;
        if (r.tags) {
            u = r.tags, i(null == (f = b) ? void 0 : f.experiments, l) ? u.forEach((e => {
                var t;
    ...
    async function oe(e) {
        const {
            ...
            language: c,
            categories: a
        } = e, s = Z("site-override"), u = Z("apps-override"), l = ne(r, t, i), f = window.consentPolicyManager, g = !i && f ? f._getConsentPolicyHeader() : {}, p = function(e) {
            const t = e.wixEmbedsAPI,
                n = t && t.getCurrentPageInfo;
            return "function" == typeof n ? n() : {}
        }(window), m = Z("omit"), h = await async function() {
            let e;
            const t = L();
            if ("function" == typeof t) try {
                e = await t()
            } catch (e) {}
            e || (e = _(window.wixEmbedsAPI.getAppToken, d));
            return e
        }();
        h && (g.authorization = h), Q(l, (e => {
            ee(e, {
        ...
        function t() {
            ...
            ! function() {
                ...
                Object.defineProperty(e, "wixTagManager", {
                    ...
                    configurable: !1,
                    enumerable: !0
                }), D($.TAG_MANAGER_LOADED, window, window.wixTagManager)
            }(),
            function(e) {
                if ("function" == typeof e.getAccessTokenFunction) {
                    P();
                    S(e.getAccessTokenFunction())
                }
            }(t), oe({
                ...
                wixSite: t.isWixSite()
            }), t.registerToEvent("pageNavigation", re), document.addEventListener("consentPolicyChanged", ie)
        }! function() {
